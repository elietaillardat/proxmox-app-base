...
public class Constants {
	...
	public static String USER_NAME = "taillard"; // user name
	public static String PASS_WORD = "2007Et96"; // password
	
	
	public static String HOST = "srv-px1.insa-toulouse.fr";
	public static String REALM = "Ldap-INSA";
	
	public static String SERVER1 = "srv-px7";
	public static String SERVER2 = "srv-px8";
	public static String CT_BASE_NAME = "ct-tpiss-virt-A4-ct";
	public static long CT_BASE_ID = 1400;
